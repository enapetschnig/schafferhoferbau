-- Aenderungswuensche: Melden direkt aus der App
--
-- Jeder Angemeldete kann eine Meldung abgeben (Wunsch / Fehler / Frage),
-- wahlweise getippt oder als Sprachnachricht, mit automatischem
-- Bildschirmfoto. Administratoren sehen alle Meldungen, setzen den Status
-- und antworten.
